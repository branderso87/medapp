var temp = document.querySelector('.drugName').innerHTML
console.log(temp)

fetch(`https://rxnav.nlm.nih.gov/REST/rxcui.json?name=${temp}`) // use QuerySelector to get and set drug search
